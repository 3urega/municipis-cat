...
"build:capacitor:direct": "powershell -NoProfile -ExecutionPolicy Bypass -File scripts/build-capacitor.ps1"
"build:capacitor:unix": "node scripts/run-capacitor-build.mjs"
"cap:sync": "cap sync"
